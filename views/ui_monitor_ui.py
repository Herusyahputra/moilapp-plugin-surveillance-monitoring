...
class Ui_Monitor(object):
    def setupUi(self, Monitor):
        ...
        self.labelFrame = QtWidgets.QFrame(parent=Monitor)
        self.labelFrame.setMinimumSize(QtCore.QSize(300, 260))
        self.labelFrame.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.labelFrame.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        ...
        self.displayLab = QtWidgets.QLabel(parent=self.labelFrame)
        ...
        self.display.addWidget(self.labelFrame)
