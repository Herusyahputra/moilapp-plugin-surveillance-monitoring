# Form implementation generated from reading ui file 'c:\Users\nueim\OneDrive\Desktop\C Projects (Assessments)\EWX-Moilapp\src\plugins\moilapp-plugin-surveillance-monitoring\views\setup.ui'
#
...
class Ui_Setup(object):
    def setupUi(self, Setup):
        ...
        self.verticalFrame_3 = QtWidgets.QFrame(Setup)
        ...
        self.frame_3 = QtWidgets.QFrame(self.verticalFrame_3)
        ...
        self.label_title_image_result = QtWidgets.QLabel(self.frame_3)
        ...
        self.label_title_original = QtWidgets.QLabel(self.frame_3)
        ...
        self.label_image_result = QtWidgets.QLabel(self.frame_2)
        ...
        self.label_image_original = QtWidgets.QLabel(self.frame_2)
        ...
        self.label_pos_x = QtWidgets.QLabel(self.frame)
        ...
        self.label_pos_y = QtWidgets.QLabel(self.frame)
        ...
        self.label_alpha = QtWidgets.QLabel(self.frame)
        ...
        self.label_beta = QtWidgets.QLabel(self.frame)
        ...
        self.frame1 = QtWidgets.QFrame(self.verticalFrame_3)
        ...
        self.comboBox_resolution_sources = QtWidgets.QComboBox(self.frame_4)
        ...
        self.frame_5 = QtWidgets.QFrame(self.setModeFrame)
        self.frame_5.setObjectName("frame_5")
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout(self.frame_5)
        self.horizontalLayout_6.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.modeSelect = QtWidgets.QFrame(self.frame_5)
        ...
        self.labelZoom = QtWidgets.QLabel(self.modeSelect)
        ...
        self.doubleSpinBox_zoom = QtWidgets.QDoubleSpinBox(self.modeSelect)
        ...
        self.labelAlpha = QtWidgets.QLabel(self.frame_6)
        ...
        self.labelBeta = QtWidgets.QLabel(self.frame_6)
        ...
        self.doubleSpinBox_beta = QtWidgets.QDoubleSpinBox(self.frame_6)
        ...
        self.labelRoll = QtWidgets.QLabel(self.frame_6)
        ...
        self.doubleSpinBox_roll = QtWidgets.QDoubleSpinBox(self.frame_6)
        ...
        self.navigationFrame = QtWidgets.QFrame(self.frame2)
        ...
        self.frame3 = QtWidgets.QFrame(self.navigationFrame)
        ...
        self.leftButton = QtWidgets.QPushButton(self.frame3)
        self.leftButton.setMinimumSize(QtCore.QSize(60, 60))
        self.leftButton.setMaximumSize(QtCore.QSize(50, 50))
        self.leftButton.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(f"{source_path}/left.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.frame4 = QtWidgets.QFrame(self.navigationFrame)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(f"{source_path}/center.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.belowButton = QtWidgets.QPushButton(self.frame4)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(f"{source_path}/down.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
