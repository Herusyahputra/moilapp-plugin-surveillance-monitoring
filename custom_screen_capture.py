...
class ScreenRecorder:
    def __init__(self, frame, fps=RECORDING_FPS, filename='output.mp4'):
        self.frame = frame
        self.fps = fps
    ...
    def capture_frame(self):
        qt_pixmap: QPixmap = QPixmap(self.frame.size())
    ...
    def save_video(self):
        if not self.frames: print("No frames captured."); return
